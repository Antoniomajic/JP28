# c:\xampp\mysql\bin\mysql -uroot --default_character_set=utf8 < C:\javaprogrameri\dz1\ColloquiumPractice\Practice10\Practice10.sql
...
--INSERTS
INSERT INTO fiance (id,thirdTime,firstTime,skirt,euro)
	VALUES
			(NULL,'2015-12-12','1997-01-01','Short skirt','458.661');

INSERT INTO sister (id,skirt,eyeColor,indifferent,sweatshirt,secondTime,firstTime,fiance)
	VALUES 
			(NULL,'Short skirt','Blue',1,'Adidas','2007-01-09','2005-06-18',1);

INSERT INTO enemy (id,density,sweatshirt,marks,hairstyle)
	VALUES
			(NULL,'154.77','Nike','450.11','Short hair'),
			(NULL,'15.707','Bike','5.11','Long hair'),
			(NULL,'14.7','Cike','45.1','Curly hair');

INSERT INTO fatherInLaw (id,lipa,euro,hairstyle)
	VALUES
			(NULL,'457','51','Short hair'),
			(NULL,'4','510','Medium short hair'),
			(NULL,'57','1','Long hair');

INSERT INTO fatherInLaw_enemy (id,fatherInLaw,enemy)
	VALUES
			(NULL,1,1),
			(NULL,2,2),
			(NULL,3,3);

INSERT INTO motherInLaw (id,euro,socks,kuna,TShirt,introverted,fatherInLaw)
	VALUES
			(NULL,'457.66','Grey socks','777.51','Blue T-Shirt',0,1),
			(NULL,'57.66','Gay socks','7.51','Gray T-Shirt',1,3),
			(NULL,'45.66','Groovy socks','77.51','Black T-Shirt',0,2);

INSERT INTO youngMan (id,pants,lipa,hairstyle,ring,marks,motherInLaw)
	VALUES
			(NULL,'Blue pants','1','Short hair',501,'44.61',1),
			(NULL,'Black pants','471','Wavy hair',5,'404.61',2),
			(NULL,'Gray pants','100','Long hair',null,'4.61',3);

INSERT INTO woman (id,marks,TShirt,indifferent,firstTime,youngMan)
	VALUES	
			(NULL,'100.1','Puma',0,'1999-12-12',1);
