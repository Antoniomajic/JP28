...
public class Practice13UvjetnoGrananjeIf {
	...
	public static void main(String[] args) {
		...
		if (uvjet) { // ovakvu sintaksu ćete rjeđe susretati
			// true grana
			System.out.println("1"); // ako je uvjet true onda ispiši 1
		}

		// opcionalno
		else {
			// false grana
			System.out.println("2"); // ako uvjet nije true onda ispiši 2
		}

		int i = 1;
		// češće korištena sintaksa
		if (i > 0) {
			System.out.println("3");
		}

		// čita se: ako je i veće od 1 onda ispiši 3
		...
		// korištenje logičkih operatora: & (and) | (or-ili) (alt gr W) ! (not-nije)
		...
		if (!tocno) { // NE OVO tocno=false (dakle: nije tocno==true, onda je false)
